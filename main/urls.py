...
from aluno.views import aluno_criar,index,aluno_listar,aluno_editar,aluno_remover, cidade_criar,cidade_listar,cidade_editar,cidade_remover, curso_criar,curso_listar,curso_editar,curso_remover
